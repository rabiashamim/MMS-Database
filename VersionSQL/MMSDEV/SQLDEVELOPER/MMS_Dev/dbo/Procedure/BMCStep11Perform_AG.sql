/****** Object:  Procedure [dbo].[BMCStep11Perform_AG]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- Description:               
--==========================================================================================
CREATE   PROCEDURE dbo.BMCStep11Perform_AG @pStatementProcessId DECIMAL(18, 0)
AS
BEGIN
...
SET b.BMCMPData_CapacitySold=
    ...
    --END 
	 CASE
        WHEN bd.BMCVariablesData_CapacityBalancePositiveSum <= bd.BMCVariablesData_CapacityBalanceNegativeSum AND b.BMCMPData_CapacityBalance >0  THEN 
            CAST( b.BMCMPData_CapacityBalance AS DECIMAL(25,0))
		   WHEN bd.BMCVariablesData_CapacityBalancePositiveSum > bd.BMCVariablesData_CapacityBalanceNegativeSum AND b.BMCMPData_CapacityBalance >0  THEN 
             CAST(b.BMCMPData_CapacityBalance AS DECIMAL(25,13))* CAST((CAST(BMCVariablesData_CapacityBalanceNegativeSum AS DECIMAL(25,13))/CAST(BMCVariablesData_CapacityBalancePositiveSum AS DECIMAL(25,0))	) AS DECIMAL(25,0)) 
			 ELSE 0 
 ...
 --   END
	CASE
       WHEN bd.BMCVariablesData_CapacityBalancePositiveSum <= bd.BMCVariablesData_CapacityBalanceNegativeSum AND b.BMCMPData_CapacityBalance <0  THEN 
            CAST(CAST((cast (b.BMCMPData_CapacityBalance AS DECIMAL(25,13)) * CAST(BMCVariablesData_CapacityBalancePositiveSum AS DECIMAL(25,0))) AS DECIMAL(25,13)) / BMCVariablesData_CapacityBalanceNegativeSum AS DECIMAL(25,0))
	    WHEN bd.BMCVariablesData_CapacityBalancePositiveSum > bd.BMCVariablesData_CapacityBalanceNegativeSum AND b.BMCMPData_CapacityBalance <0  THEN 
             CAST(b.BMCMPData_CapacityBalance AS DECIMAL(25,0)) ELSE 0 
