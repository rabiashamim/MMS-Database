/****** Object:  Procedure [dbo].[WF_Get_ApprovalPopUp_RS]    Committed by VersionSQL https://www.versionsql.com ******/
...
--Comments :                                                                   
--======================================================================                                                             
CREATE procedure dbo.WF_Get_ApprovalPopUp_RS                                                
...
SELECT  
 @modprocessid = RuModulesProcess_Id  FROM RuModulesProcess  
...
SELECT  
 @query = CONCAT('select @Result=', @from_sql, ' from ', RuModulesProcess_LinkedObject, ' where ', @where, '=', @ProcessId)  
FROM RuModulesProcess  
WHERE RuModulesProcess_Id = @modprocessid  
...
SELECT TOP 1  
 @withdraw_Suspension_Application_Date = MtContractRegistrationActivities_ApplicationDate  
   ,@withdraw_Suspension_Application_no = MtContractRegistrationActivities_ApplicationNo  FROM MtContractRegistrationActivities  
