...
--Comments :                         
--======================================================================                   
CREATE procedure WF_Get_ApprovalPopUp      
...
select @RuNotificationSetup_EmailSubject      
    = replace(      
       ...
       @RuNotificationSetup_EmailBody = replace(replace(replace(replace(RuNotificationSetup_EmailBody,'@ProcessName',@ProcessName)      
            ,'@ProcessId',@ProcessId)    
