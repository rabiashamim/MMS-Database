...
CREATE   procedure dbo.WF_GetProcessDetail_RS                                                       
...
left join Lu_Designation de on de.Lu_Designation_Id=u.Lu_Designation_Id                              
 ...
 select @RuNotificationSetup_ID=RuNotificationSetup_ID from RuNotificationSetup where RuModules_id=@module_id                                                          
 and RuNotificationSetup_CategoryKey=  'process_approval'                                                                                                
                                    
 select @NotificationBody=RuNotificationSetup_EmailBody                                                                           
...
update #WF_history                                   
 ...
 update #WF_history                                   
 set NotificationBody = replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(REPLACE (REPLACE(REPLACE                    
