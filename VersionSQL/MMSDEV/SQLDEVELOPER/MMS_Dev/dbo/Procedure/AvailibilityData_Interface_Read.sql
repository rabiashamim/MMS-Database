...
--exec AvailibilityData_Interface_Read 532,1,100000              
...
,@pMtAvailibilityData_SyncStatus NVARCHAR(MAX) = NULL    
,@pMtAvailibilityData_GeneratingCapacity NVARCHAR(MAX) = NULL    
...
DROP TABLE IF EXISTS #temp_GenerationAvailability      
  ...
  AND (@pMtAvailibilityData_SyncStatus IS NULL OR MtAvailibilityData_SyncStatus = @pMtAvailibilityData_SyncStatus)    
  AND (@pMtAvailibilityData_GeneratingCapacity IS NULL OR MtAvailibilityData_GeneratingCapacity = @pMtAvailibilityData_GeneratingCapacity)    
