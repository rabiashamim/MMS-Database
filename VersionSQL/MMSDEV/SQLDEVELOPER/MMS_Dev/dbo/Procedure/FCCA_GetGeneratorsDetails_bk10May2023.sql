/****** Object:  Procedure [dbo].[FCCA_GetGeneratorsDetails_bk10May2023]    Committed by VersionSQL https://www.versionsql.com ******/

-- FCCA_GetGeneratorsDetails 17,1  
--select * from MtFCCAMaster
CREATE Procedure dbo.FCCA_GetGeneratorsDetails_bk10May2023   
  ...
  (SELECT  
   ...
   SELECT  
    @pMtFCCAMaster_Id  
	  ...
	  ,ToBeCancelecount
	  ,ToBeCanceledate
	  , case when ToBeCancelecount>0 then 1 else 0 end as CotnractsToBeRevised
