/****** Object:  View [dbo].[vw_settlementProcesse]    Committed by VersionSQL https://www.versionsql.com ******/

create view vw_settlementProcesse
as
select  CONCAT(SPD.SrProcessDef_Name, ' - ', SSD.SrStatementDef_Name) ProcessName,                                              
 LuAccountingMonth_MonthName SettlementPeriod,                                              
