/****** Object:  View [dbo].[ASC_GuParties]    Committed by VersionSQL https://www.versionsql.com ******/
...
INNER JOIN RuCDPDetail RU ON RU.RuCDPDetail_Id=MC.MtCDPDetail_Id
  ...
  on  RU.RuCDPDetail_CongestedZoneID=cz.MtCongestedZone_Id
WHERE 
