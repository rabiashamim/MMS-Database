/****** Object:  Procedure [dbo].[Insert_GenerationAvailabilityDataV2_rs]    Committed by VersionSQL https://www.versionsql.com ******/

  
CREATE   PROCEDURE [dbo].[Insert_GenerationAvailabilityDataV2_rs]  
...
BEGIN  
 ...
 SELECT @vMtAvailabilityData_Id=ISNUll(MAX(MtAvailibilityData_Id),0)+1 FROM MtAvailibilityData    
  ...
  --convert(VARCHAR, CAST(MtAvailibilityData_Date AS DATE), 105),
  MtAvailibilityData_Hour,  
  MtGenerationUnit_Id,  
  MtAvailibilityData_AvailableCapacityASC,  
  MtAvailibilityData_ActualCapacity  
