/****** Object:  Procedure [dbo].[WF_InsertHistory_data]    Committed by VersionSQL https://www.versionsql.com ******/

            
CREATE   procedure dbo.WF_InsertHistory_data                                                        
 @RuModuleId int,                            
...
END                           
 /*Party Registration*/        
IF @RuModuleId =1 and @Process_Template_Id=1-- 13                                    
BEGIN                                    
UPDATE MtPartyRegisteration                                    
SET LuStatus_Code_Approval = 'APRO'                                    
WHERE MtPartyRegisteration_Id = @ProcessId                       
                    
-- if @Process_Template_Id=1                    
--begin                     
--"update MtPartyCategory set LuStatus_Code='APRO' where MtPartyCategory_Id=" + partyCategoryId;                    
--end                     
...
CASE                                    
 WHEN @Process_Template_Id = 1 THEN 'CAIN'                                    
 WHEN @Process_Template_Id = 2 THEN 'CAMI'                                    
 WHEN @Process_Template_Id = 3 THEN 'CADI'                               
 WHEN @Process_Template_Id = 4 THEN 'CASI'                                    
 WHEN @Process_Template_Id = 5 THEN 'CAWI'                          
 WHEN @Process_Template_Id = 6 THEN 'CATI'                                    
END                                    
WHERE MtContractRegistration_Id = @ProcessId                                    
...
UPDATE MtFCDMaster                                    
SET MtFCDMaster_ApprovalStatus = 'InProcess'                                    
WHERE MtFCDMaster_Id = @ProcessId                                    
END      
...
UPDATE MtFCCMaster                                    
SET MtFCCMaster_ApprovalCode = 'InProcess'                                    
WHERE MtFCCMaster_Id = @ProcessId                                    
END    
...
UPDATE MtFCCAMaster                                    
SET MtFCCAMaster_ApprovalStatus = 'InProcess'                                    
WHERE MtFCCAMaster_Id = @ProcessId                                    
END       
...
IF @RuModuleId = 1 and     @Process_Template_Id=2                                
BEGIN                                    
...
IF @RuModuleId = 1 and     @Process_Template_Id=3 --@RuModuleId = 15                                    
BEGIN                                    
...
UPDATE MtFCDMaster                                    
SET MtFCDMaster_ApprovalStatus = 'Draft'                                    
WHERE MtFCDMaster_Id = @ProcessId                                    
END     
...
UPDATE MtFCCMaster                                    
SET MtFCCMaster_ApprovalCode = 'Draft'                                    
WHERE MtFCCMaster_Id = @ProcessId                                    
END    
...
UPDATE MtFCCAMaster                                    
SET MtFCCAMaster_ApprovalStatus = 'Draft'                                    
WHERE MtFCCAMaster_Id = @ProcessId                                    
END   
...
WHERE MtStatementProcess_ID = @ProcessId          
/*ERP Integration*/      
select @SrProcessDef_ID=SrProcessDef_ID      
from MtStatementProcess where MtStatementProcess_ID=@ProcessId      
      
if @SrProcessDef_ID in (10,11) /*Aggregated PSS FSS*/      
begin       
exec [MmsErpIntegrationForSettlementData] @ProcessId      
end       
/*ERP Integration*/      
...
UPDATE MtFCDMaster                                    
SET MtFCDMaster_ApprovalStatus = 'Approved'     
   ,MtFCDMaster_ProcessStatus = 'Completed'     
WHERE MtFCDMaster_Id = @ProcessId                                    
END    
...
UPDATE MtFCCMaster                                    
SET MtFCCMaster_ApprovalCode = 'Approved'   ,    
LuStatus_Code='Completed'    
WHERE MtFCCMaster_Id = @ProcessId    

exec [dbo].[FCC_administartion] @user_id , @ProcessId
...
UPDATE MtFCCAMaster                                    
SET MtFCCAMaster_ApprovalStatus = 'Approved'   ,    
MtFCCAMaster_Status='Completed'    
WHERE MtFCCAMaster_Id = @ProcessId   
...
IF @RuModuleId = 1 and     @Process_Template_Id=2-- @RuModuleId = 14                                    
BEGIN               
...
IF @RuModuleId = 1 and     @Process_Template_Id in (3,6) --@RuModuleId IN (15, 18)                                    
BEGIN                                    
;                                    
WITH cte                                    
AS                                    
