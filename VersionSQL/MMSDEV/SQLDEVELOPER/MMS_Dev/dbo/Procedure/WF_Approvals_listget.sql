...
begin              
 ...
 where ISNULL(RuWorkFlowHeader_isDeleted,0)=0    
...
begin              
  ...
  into #temp        
   ...
   on r.Lu_Department_Id=dp.Lu_Department_Id          
    ...
    where h.RuWorkFlowHeader_id = @RuWorkFlowHeader_id  and ISNULL(h.RuWorkFlowHeader_isDeleted,0) =0  and ISNULL(d.RuWorkFlow_detail_isDeleted,0)=0        
...
inner join AspNetUsers r              
        ...
        left join Lu_Department dp          
   on r.Lu_Department_Id=dp.Lu_Department_Id       
    --where ISNULL(h.RuWorkFlowHeader_isDeleted,0) =0  and ISNULL(d.RuWorkFlow_detail_isDeleted,0)=0        
 order by RuWorkFlow_detail_levelId          
end            
