...
BEGIN                
   ...
   ELSE IF @pMtRegisterationActivity_Id_Suspension_modification>0            
   begin            
       UPDATE             
        MtRegisterationActivities                
         SET                
            ...
            ,MtRegisterationActivities_OrderDate=@pOrderApprovedDate          
         WHERE                 
          MtRegisterationActivity_Id in (@pMtRegisterationActivity_Id_Suspension_modification,@pMtRegisterationActivity_Id)                
