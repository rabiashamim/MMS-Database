/****** Object:  Table [dbo].[RuCDPDetail_audit]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE TABLE dbo.RuCDPDetail_audit(
	[RuCDPDetail_audit_Id] [decimal](18, 0) IDENTITY(1,1) NOT NULL,
