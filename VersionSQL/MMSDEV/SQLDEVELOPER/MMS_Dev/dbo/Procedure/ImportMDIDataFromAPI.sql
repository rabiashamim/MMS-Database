/****** Object:  Procedure [dbo].[ImportMDIDataFromAPI]    Committed by VersionSQL https://www.versionsql.com ******/
...
--======================================================================
--  [dbo].[ImportMDIDataFromAPI] @pStartDate='1-05-2022' , @pEndDate='31-05-2022' , @pType=1
--select * from [dbo].[InterfaceMtMonthlyMDI]
--truncate table InterfaceMtMonthlyMDI

CREATE PROCEDURE [dbo].[ImportMDIDataFromAPI]
