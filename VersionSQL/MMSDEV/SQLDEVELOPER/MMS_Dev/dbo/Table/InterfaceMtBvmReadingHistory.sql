/****** Object:  Table [dbo].[InterfaceMtBvmReadingHistory]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE TABLE dbo.InterfaceMtBvmReadingHistory(
	[InterfaceMtBvmReadingHistory] [decimal](18, 0) IDENTITY(1,1) NOT NULL,
	[InterfaceMtBvmReading_Id] [decimal](18, 0) NOT NULL,
	...
	[InterfaceMtBvmReadingHistory_CreatedOn] [datetime] NOT NULL,
	[InterfaceMtBvmReadingHistory_ModifiedOn] [datetime] NULL,
	[InterfaceMtBvmReadingHistory_IsDeleted] [bit] NOT NULL,
PRIMARY KEY CLUSTERED 
(
	[InterfaceMtBvmReadingHistory] ASC
