/****** Object:  Procedure [dbo].[FCC_Execution_RS]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE PROCEDURE dbo.FCC_Execution_RS @pUserId INT  
 ...
 BEGIN TRY  
  ...
  INSERT INTO #CertificateNumbers  
   SELECT  
    @vGeneratorId  
    + '-' + @vFuelTypeId  
    + '-' + RIGHT('000000' + CAST(@i AS VARCHAR(5)), 6)  
