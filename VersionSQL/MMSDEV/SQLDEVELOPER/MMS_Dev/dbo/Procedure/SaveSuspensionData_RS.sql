/****** Object:  Procedure [dbo].[SaveSuspensionData_RS]    Committed by VersionSQL https://www.versionsql.com ******/

            
CREATE PROCEDURE dbo.SaveSuspensionData_RS            
...
@pUserId int=null,  
@pMtRegisterationActivity_Id_Suspension_modification DECIMAL(18,0)=NULL       
AS            
BEGIN            
...
if @pCase  in ('Suspension Drafted')     
BEGIN            
...
-----------Suspension modified drafted------------

if @pCase  in ('SuspensionModificationDraft')     
BEGIN            
    

select @vConnectedMPsCount1=count(1) from MtPartyRegisteration 
where MtPartyRegisteration_MPId=@pPartyRegisterationId and ISNULL(isDeleted,0)=0    
and LuStatus_Code_Applicant not in ('ATER','DER')    
...
END    
             ...
             IF @pMtRegisterationActivity_Id_Suspension_modification is NULL OR   @pMtRegisterationActivity_Id_Suspension_modification =0          
             BEGIN            
             
                      SELECT @pMtRegisterationActivity_Id_Suspension_modification= MAX(MtRegisterationActivity_Id)+1 FROM MtRegisterationActivities            
            ...
            ,MtRegisterationActivities_CreatedOn            
                      ...
                      VALUES            
                                   (            
                                   @pMtRegisterationActivity_Id_Suspension_modification            
                                   ,@pPartyRegisterationId            
                                   ,'SMDR' 
                                   ,@pApplicationNo            
                                   , NULLIF(@pApplicationDate,'')            
      ...
      Update           
                   MtPartyRegisteration           
                 SET           
                   LuStatus_Code_Approval = 'SMDR' 
                  WHERE           
                  MtPartyRegisteration_Id = @pPartyRegisterationId          
            
   END            
---------------------------------------------------------------------------            
   IF @pMtRegisterationActivity_Id_Suspension_modification> 0           
   BEGIN            
     UPDATE MtRegisterationActivities            
     SET            
            ...
            ,MtRegisterationActivities_OrderDate=ISNULL(@pOrderApprovedDate  ,MtRegisterationActivities_OrderDate)    
     WHERE             
      MtRegisterationActivity_Id = @pMtRegisterationActivity_Id_Suspension_modification            
...
---------------------------------------------------------------------------            
-----------------------------suspension modification new code below---------------------------            
---------------------------------------------------------------------------       
  
  
 if (@pCase = 'SuspensionModification')            
BEGIN            
   ...
   ,MtRegisterationActivities_OrderDate      
                      ...
                      VALUES            
                                   ...
                                   @pMtRegisterationActivity_Id_Suspension_modification            
                                   ,@pPartyRegisterationId            
              ,'SMPA'   --modification Suspension Pending For Approval         
                                   ,@pApplicationNo            
                                   ,@pApplicationDate            
                                   ,@pRemarks       
           ,@pNotes    
