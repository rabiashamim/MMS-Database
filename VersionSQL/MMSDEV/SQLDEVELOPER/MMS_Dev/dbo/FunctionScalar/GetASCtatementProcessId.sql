/****** Object:  Function [dbo].[GetASCtatementProcessId]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
--DROP FUNCTION [dbo].[GetASCtatementProcessId]
CREATE function [dbo].[GetASCtatementProcessId] 
(
...
WHERE spd.SrProcessDef_ID IN (2,5,8)
