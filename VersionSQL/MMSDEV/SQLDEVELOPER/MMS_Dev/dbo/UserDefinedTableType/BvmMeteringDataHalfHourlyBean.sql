/****** Object:  UserDefinedTableType [dbo].[BvmMeteringDataHalfHourlyBean]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE TYPE [dbo].[BvmMeteringDataHalfHourlyBean] AS TABLE(
