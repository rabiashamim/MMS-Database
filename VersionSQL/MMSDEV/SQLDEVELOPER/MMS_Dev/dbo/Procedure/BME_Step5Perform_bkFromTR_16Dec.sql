/****** Object:  Procedure [dbo].[BME_Step5Perform_bkFromTR_16Dec]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE   PROCEDURE dbo.BME_Step5Perform_bkFromTR_16Dec(			 
			@Year int,
			@Month int
